...
<section id="do_action">
	<div class="container">
		<div class="heading" align="center">
			...
			<p>Your order number is {{ Session::get('order_id') }} and total payable about is KSH {{ Session::get('grand_total') }}</p>
			...
			<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				...
				<input type="hidden" name="business" value="gitongacolin6@business.example.com">
				...
				<input type="hidden" name="city" value="{{ $orderDetails->region }}">
				<input type="hidden" name="state" value="{{ $orderDetails->county }}">
