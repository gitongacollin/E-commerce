<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2019 Soko Freshy. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://tamuventures.biz">Collin Gitonga</a></span></p>
				</div>
			</div>
		</div>
