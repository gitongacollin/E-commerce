	...
	<section id="do_action">
		<div class="container">
			<div class="heading">
				...
				<p>Choose if you have a coupon code or reward points you want to use..</p>
			</div>
			<div class="row">
				<div class="col-sm-6">
						...
						<ul class="user_option">
							<li>
								<form action="{{ url('cart/apply-coupon') }}" method="post">
									@csrf
									<label><b>Use Coupon Code:</b></label>
									<input type="text" name="coupon_code">
									<input type="submit" value="Apply" class="btn btn-default update" name="">
								</form>
							</li>
