...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url ('/admin/dashboard')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{ url('/admin/edit-coupon/'.$couponDetails->id)}}" class="current">Edit Coupon</a> </div>
    <h1>Add Coupon</h1>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="{{ url('/admin/edit-coupon/'.$couponDetails->id)}}" name="add_coupon" id="add_coupon">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input value="{{ $couponDetails->amount}}" type="number" min="1" name="amount" id="amount" required="">
                </div>
              </div>
               <div class="control-group">
