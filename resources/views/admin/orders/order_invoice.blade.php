    		...
    		<div class="row">
    			...
    			<div class="col-xs-6 text-right">
        			...
        			<strong>Shipped To:</strong><br>
		                ...
		                {{ $orderDetails->region }} <br>
		                {{ $orderDetails->county }} <br>
		                {{ $orderDetails->phone }}
    				</address>
    			</div>
    		</div>
    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
    							...
    							<tr>
    								...
    								<td class="text-center">KSH {{ $pro->product_price }}</td>
    								<td class="text-center">{{ $pro->product_qty }}</td>
    								<td class="text-right">KSH {{ $pro->product_price * $pro->product_qty }}</td>
    							</tr>
    							...
    							<tr>
    								...
    								<td class="no-line text-right">KSH 0</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">KSH {{ $orderDetails->coupon_amount }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">KSH {{ $orderDetails->grand_total }}</td>
    							</tr>
    						</tbody>
    					</table>
    				</div>
